...
var p2 = new Person("p2", "lName2", 20, "Male", [
  "dancing",
  "coding",
  "swimming",
]);
...
function hamburger() {
  var burger = {
    buns: ["premium", "value"],
    vegetables: ["pickles", "tomatoes", "onions", "lettuce"],
    cheese: "asiago",
    sauce: "mayo",
    patty: 1,
    typeOfPatty: "chicken",
    finalBurger: function () {
      return `The hamburger has ${this.buns} buns with vegetables including ${this.vegetables} having ${this.patty} patty with ${this.cheese} cheese and ${this.sauce}.`;
    },
  };
  output.textContent = burger.finalBurger();
}
hamburger();
